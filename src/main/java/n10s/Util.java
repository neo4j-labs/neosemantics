...
//
//  public static <T> T inTxOld(GraphDatabaseService db, Callable<T> callable) {
//    try {
//      return inTxFutureOld(DEFAULT, db, callable).get();
...
//  }
//
//  public static <T> T inTx(GraphDatabaseService db, Function<Transaction, T> function) {
//    try {
//      return inTxFuture(DEFAULT, db, function).get();
//    } catch (RuntimeException e) {
//      throw e;
//    } catch (Exception e) {
//      throw new RuntimeException("Error executing in separate transaction: "+e.getMessage(), e);
...
//  }
//
//  public static <T> Future<T> inTxFutureOld(ExecutorService pool, GraphDatabaseService db,
//      Callable<T> callable) {
//    try {
//      return pool.submit(() -> {
//        try (Transaction tx = db.beginTx()) {
