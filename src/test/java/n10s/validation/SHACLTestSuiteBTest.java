...
public class SHACLTestSuiteBTest {
  ...
  public void runIndividualTest(String testGroupName, String testName,
      ...
      Result dataImportResults = session.run(
              "CALL n10s.rdf.import.fetch(\"" + SHACLTestSuiteBTest.class.getClassLoader()
      ...
      Result shapesLoadResults = session
          .run("CALL n10s.validation.shacl.import.fetch(\"" + SHACLTestSuiteBTest.class
              .getClassLoader()
      ...
      Result loadShapesAsNodes = session
          .run("CALL n10s.rdf.import.fetch(\"" + SHACLTestSuiteBTest.class
              .getClassLoader()
      ...
      Result resultsLoadResult = session.run("call n10s.rdf.import.fetch('" + SHACLTestSuiteBTest.class
              .getClassLoader()
