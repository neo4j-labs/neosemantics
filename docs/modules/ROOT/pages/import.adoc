...
* xref:config.adoc#create-resource-uniqueness-constraint[Section 3.2, “Pre-requisite: Create uniqueness constraint”]
* xref:import.adoc#graph-configuration[Section 3.1, “Setting the configuration of the graph”]
...
include::example$n10s.rdf.hasLangTag.csv[]
include::example$n10s.rdf.getLangTag.csv[]
|===
