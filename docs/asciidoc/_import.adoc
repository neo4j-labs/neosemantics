...
In its most basic form the `n10s.rdf.import.fetch` method just takes the url string to access the RDF data and the serialisation format.
...
More details in section <<custom_ns>>.
...
[source,cypher]
----
call n10s.rdf.import.fetch("https://github.com/neo4j-labs/neosemantics/raw/3.5/docs/rdf/miniinstances.ttl","Turtle", { typesToLabels: false });
----
...
To avoid this, you can use link:https://neo4j-contrib.github.io/neo4j-apoc-procedures/#_nodes_collapse[APOC Nodes collapse].
