...
Additionally, you can provide a graph URI to specify the context of the given resource. Here is how you can do that on the RDF dataset we imported in <<ImportQuadRDF>> section:
